...
class Images extends App\Cb\Base {
	...
	protected function isAllowed($_files_array=[]) {
		return App\Cb\Properties\Files::isAllowed($_files_array, 'image');
	}
	...
	protected function save($_property_id, $_files_array=[]) {
		...
		return App\Cb\Properties\Files::save($pid, $_files_array, 'image');
	}
	
	protected function isMaxExceeded($_property_id) {
		return App\Cb\Properties\Files::isMaxExceeded($_property_id, 'image');
	}
}